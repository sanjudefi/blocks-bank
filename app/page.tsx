          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <div className="font-black text-foreground text-lg">Blocks Bank</div>
                  <div className="text-xs text-muted-foreground">by Catchway Technology</div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="font-black text-foreground text-sm">Blocks Bank</div>
                <div className="text-[10px] text-muted-foreground">blocksbank.catchway.info</div>
              </div>
            </div>
